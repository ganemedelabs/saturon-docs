---
title: Grammar-Aware Parsing
description: How Saturon parses any valid CSS Color Level 5 input using its grammar-aware runtime.
---
...
## Overview of the CSS `<color>` Grammar [#overview]
...
## Core Type: `ColorConverter` [#core-type]
...
## Handling `<color-base>` [#color-base]
...
## Handling `<color-function>` [#color-function]
